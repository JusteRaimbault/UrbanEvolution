setwd(paste0(Sys.getenv('CS_HOME'),'/UrbanEvolution/Models/QuantEpistemo'))
...
edge_file = 'export/alife_links.csv'
node_file = 'export/alife.csv'
...
for(j in 8:9){nodes[,j]=as.numeric(unlist(nodes[,j]))}
kws = names(nodes)[8:9]
